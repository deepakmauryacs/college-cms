 ...
 <!-- Calendar JavaScript -->
    ...
    $(document).ready(function($) {
	 ...
	 <!-- Chart Files -->
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/flot.tooltip/0.9.0/jquery.flot.tooltip.js" integrity="sha512-4jOXwAvWJaEuWFGAkgL9833l10T1fHDJmFpnDPH4QX0STaGiTq8NrzqIIbVR3pbiklPf+sDW9dW7K6fg7xgmeA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
